                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      <Button
                        ...
                        role="combobox"
                        className={cn(
                          " justify-between aria-selected:text-accent-foreground data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
                  ...
                  <PopoverContent className="w-[200px] p-0">
                    <Command>
                      ...
                      <CommandGroup>
                      {Array.isArray(orgDepartments) && orgDepartments.length > 0 ? (
                      ...
                      orgDepartments.map((dpt) => (
                        <CommandList>
                          ...
                          >
                            <BsCheckLg
                              className={cn(
                                "mr-2 h-4 w-4 aria-selected:text-accent-foreground data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-[200px] p-0">
                    <Command>
                      ...
                      <CommandGroup>
                      {Array.isArray(orgTitles) && orgTitles.length > 0 ? (
